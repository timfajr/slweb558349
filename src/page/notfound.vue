<template>
    ...
    <center class="m-auto flex flex-col justify-center align-center w-screen self-center h-full">
    ...
    <span class="text-white text-6xl block pt-10 pb-4 animate-pulse "><span>4  0  4</span></span>
