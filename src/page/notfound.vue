<template>
    ...
    <div class="m-auto flex flex-col justify-center align-center w-screen self-center h-full">
    <img src="../images/Untitled.png" class="object-contain h-32 w-18 rounded mb-10 animate-pulse" />
    ...
    <span class="text-white text-6xl block pt-10 pb-4 animate-pulse text-center"><span>4  0  4</span></span>
    ...
    <div class="mt-2 flex flex-row text-center justify-center self-center space-x-2">
      ...
      <a href="https://www.w3schools.com" class="text-white text-md p-2 rounded-xl bg-white bg-opacity-10"> <font-awesome-icon icon="fa-solid fa-box-archive" />  Marketplace </a>
      <p class="text-white text-md py-2"> Or </p>
      <a href="https://www.w3schools.com" class="text-white text-md p-2 rounded-xl bg-white bg-opacity-10"> <font-awesome-icon icon="fa-solid fa-store" /> Inworld Store </a>
    </div>
    <a href="secondlife:///app/agent/439c4909-5e04-4ddc-80d9-a7dda347fb5d/about" class="flex text-center justify-center self-center text-white pt-10 animate-pulse text-sm">😎 Developed By Getown 🚀</a>
    </div>
    </div>
    </body>
